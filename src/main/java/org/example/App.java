...
public class App {
        ...
        do {
            ...
            switch (val) {
                ...
                case "4":
                    ...
                    break;
                case "5":
                    float rang = (float) ((maxelPris(elPris) - minstelPris(elPris))) / 5;
    ...
    public static void diagram(int[] arraye, float rang, int counter, int input,float min) {
        String[] c = new String[24];
        for (int i = 0; i < 24; i++) {
            if (counter == 1) c[i] = "x";
            else if (arraye[i] <= input && arraye[i] >= ((int)(counter - 1) * (int)rang)+ (float) min) c[i] = "x";
            else c[i] = " ";
        }
    ...
    public static void diagram1(int[] arraye, float rang, int counter, int input,int min) {
        String[] c = new String[24];
        for (int i = 0; i < 24; i++) {
            if (counter == 1) c[i] = "x";
            else if (arraye[i] <= input && arraye[i] >= ((int)(counter - 1) * (int)rang)+(float) min) c[i] = "x";
